...
class ComputeShaderExample_kt  : BasicRenderer_kt()  {
    ...
    override fun onSurfaceCreated(gl10: GL10?, eglConfig: EGLConfig?) {
        ...
        GLES20.glBindBuffer(GLES31.GL_SHADER_STORAGE_BUFFER, VBO.get(0))
        GLES20.glBufferData(
            GLES31.GL_SHADER_STORAGE_BUFFER, java.lang.Float.BYTES * hA!!.capacity(), hA,
            GLES20.GL_STATIC_DRAW
        )
        GLES20.glBindBuffer(GLES31.GL_SHADER_STORAGE_BUFFER, VBO.get(1))
        GLES20.glBufferData(
            GLES31.GL_SHADER_STORAGE_BUFFER, java.lang.Float.BYTES * hB!!.capacity(), hB,
            GLES20.GL_STATIC_DRAW
        )
        GLES20.glBindBuffer(GLES31.GL_SHADER_STORAGE_BUFFER, VBO.get(2))
        GLES20.glBufferData(
        ...
        GLES31.glBindBufferBase(GLES31.GL_SHADER_STORAGE_BUFFER, 1, VBO.get(0))
        GLES31.glBindBufferBase(GLES31.GL_SHADER_STORAGE_BUFFER, 2, VBO.get(1))
        GLES31.glBindBufferBase(GLES31.GL_SHADER_STORAGE_BUFFER, 3, VBO.get(2))
