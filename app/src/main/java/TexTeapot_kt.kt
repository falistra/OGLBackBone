...
class TexTeapot_kt : BasicRenderer_kt() {
    ...
    override fun setContextAndSurface(context: Context?, surface: GLSurfaceView?) {
        ...
        this.surface!!.setOnClickListener {
            texSelector = if (texSelector == 0) {
                Log.v(BasicRenderer.TAG, "Procedurally calculating tex coords in the VS")
                1
            } else {
                Log.v(BasicRenderer.TAG, "Using texcoords are read from .ply file")
                0
            }
        }
    }
    ...
    override fun onSurfaceCreated(gl10: GL10?, eglConfig: EGLConfig?) {
        ...
        texSelectorLoc = GLES20.glGetUniformLocation(shaderHandle, "texSelector")
        ...
        opts.inScaled = false
        val bitmap = BitmapFactory.decodeResource(context!!.resources, R.drawable.quilt, opts)
    ...
    override fun onDrawFrame(gl10: GL10?) {
        ...
        GLES20.glUniform1i(texSelectorLoc, texSelector)
