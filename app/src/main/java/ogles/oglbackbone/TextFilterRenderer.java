...
public class TextFilterRenderer extends BasicRenderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        VAO = new int[1]; //one VAO to bind the vpos
        ...
        opts.inScaled=false;
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(),R.drawable.tiles,opts);
        ...
        for(int i=0; i<extensions.length(); i++) {
            ...
            else e += extensions.charAt(i);
        }

        if(extensions.contains("anisotropic"))
            Log.v(TAG,"Anisotropic filtering supported");
        else  Log.v(TAG,"Anisotropic filtering NOT supported. " +
