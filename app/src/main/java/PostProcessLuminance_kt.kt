...
class PostProcessLuminance_kt  : BasicRenderer_kt() {
    ...
    private lateinit var texUnitSkyAndBunny: IntArray
    private lateinit var texUnitFBO: IntArray
    ...
    private var scissorPosition = 800f
    private var uScissorPosition : Int = 0
    ...
    override fun setContextAndSurface(context: Context?, surface: GLSurfaceView?) {
        ...
        this.surface!!.setOnTouchListener { view, motionEvent ->
            ...
            when (action) {
                MotionEvent.ACTION_DOWN -> scissorPosition = motionEvent.x
    ...
    override fun onSurfaceCreated(gl10: GL10?, eglConfig: EGLConfig?) {
        ...
        val vertexDataBunny = ByteBuffer.allocateDirect(
            verticesBunny!!.size * java.lang.Float.BYTES
        )
            .order(ByteOrder.nativeOrder())
            .asFloatBuffer()
